...
function selectOriginalDocumentUrl(report = {}) {
...
export const handler = async (event) => {
  ...
  try {
    ...
    if (isDbsecGate) {
      ...
      if (!proxyLooksGood && proxyLooksGood !== 'attachment' && !isKakaoTalk && !isAndroid) {
        finalUrl = pdfUrl;
      } else {
        ...
        finalUrl = isAndroid || isKakaoTalk || proxyLooksGood === 'attachment'
